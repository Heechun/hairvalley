...
public interface HairValleyCommonService {
	...
	int insertUserRegister(String user_id, String user_pw, String user_name, String user_email, String user_phone, String user_loc, String user_sex) throws Exception;
