				...
				<div id="hornav" class="visible-lg">
					...
					<form class="navbar-form" action="/sample/hairvalley_login.do" method="post">
						<div class="form-group" style="margin-bottom:1px;">
							<input type="text" name="user_id" placeholder="ID or 사업자번호" class="form-control" style="width:auto;">
						</div>
						<div class="form-group">
							<input type="password" name="user_pw" placeholder="Password" class="form-control" style="width:auto;">
						</div>
