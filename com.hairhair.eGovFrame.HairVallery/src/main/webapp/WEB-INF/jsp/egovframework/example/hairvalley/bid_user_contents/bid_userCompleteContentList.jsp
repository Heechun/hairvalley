											...
											<tbody>
												<c:forEach items="${bidBoardList}" var="bidBoardList">
													<tr>
														...
														<td><a
															href="/sample/bid_selectUserBidCompleteContent.do?text_num=${bidBoardList.text_num}&content_num=${bidBoardList.content_num}"><span style="color:blue;">[계약완료]</span>&nbsp;&nbsp;${bidBoardList.title}</a></td>
