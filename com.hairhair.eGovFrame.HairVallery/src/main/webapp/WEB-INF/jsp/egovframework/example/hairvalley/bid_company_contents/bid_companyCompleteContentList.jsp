								...
								<div class="col-md-12">
													...
													<tr>
														...
														<td>
															<a href="/sample/bid_selectBoardContent.do?text_num=${bidBoardList.text_num}&content_num=${bidBoardList.content_num}">
																<span style="color:blue;">[계약완료]</span>&nbsp;&nbsp;${bidBoardList.title}
															</a>
														</td>
									...
									<div class="row margin-vert-10">
										<div class="col-md-8">
											<ul class="pagination">
												<c:if test="${page > 1}">
													<li><a href="companyBidContentComplete.do?company_id=${company_id}&page=${page-1}">&laquo;</a>
													</li>
												</c:if>
												<c:if test="${page == 1}">
												...
												<c:forEach var="num" begin="1" end="${totalpage}" step="1">
													<c:if test="${page == num}">
														<li class="active"><a
															href="companyBidContentComplete.do?company_id=${company_id}&page=${num}">${num}</a></li>
													</c:if>
													<c:if test="${page != num}">
														<li><a href="companyBidContentComplete.do?company_id=${company_id}&page=${num}">${num}</a>
														</li>
													</c:if>
												</c:forEach>
												<li><c:if test="${fn:length( bidBoardList ) < 10}">
														...
														<li><a href="companyBidContentComplete.do?company_id=${company_id}&page=${page+1}">&raquo;</a>
														</li>
													</c:if></li>
											</ul>
										</div>
